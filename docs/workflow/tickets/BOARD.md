...
| [T-019](tickets/EPIC-05-notifications/T-019-notifications-controller.md) | NotificationsController | 2 | T-018 | yes (vs frontend) | done |
| [T-020](tickets/EPIC-05-notifications/T-020-pipeline-e2e-tests.md) | Pipeline e2e tests | 3 | T-018, T-019 | yes (vs frontend) | done |
...
| [T-028](tickets/EPIC-08-frontend-pages/T-028-history-page.md) | History page | 3 | T-025 | yes (vs T-026/T-027) | done |
...
| [T-030](tickets/EPIC-09-quality-coverage/T-030-test-hardening.md) | Test hardening (edge cases + components) | 5 | T-029 | no | in-progress |
